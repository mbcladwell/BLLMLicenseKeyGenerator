...
public class LicenseKeyGenerator extends javax.swing.JFrame implements java.awt.event.ActionListener, javax.swing.event.DocumentListener
{
  ...
  private DefaultComboBoxModel<String> litecoinUnitOfCostList = new DefaultComboBoxModel(new String[] { "Dollars", "Litecoin" });
  private DefaultComboBoxModel<String> bitcoinUnitOfCostList = new DefaultComboBoxModel(new String[] { "Dollars", "Bitcoin" });
  ...
  public LicenseKeyGenerator()
  {
    ...
    cryptocurrencyList = new JComboBox(cryptoOptionsWSelect);
    ...
    Integer[] confirmationOptions = { Integer.valueOf(0), Integer.valueOf(3), Integer.valueOf(6) };
    ...
    Integer[] expiresHours = { Integer.valueOf(1), Integer.valueOf(3), Integer.valueOf(12), Integer.valueOf(24), Integer.valueOf(48), Integer.valueOf(72), Integer.valueOf(168), Integer.valueOf(720), Integer.valueOf(8760) };
    ...
    Integer[] trialExpiresDays = { Integer.valueOf(0), Integer.valueOf(3), Integer.valueOf(7), Integer.valueOf(14), Integer.valueOf(30), Integer.valueOf(180) };
    ...
    Integer[] expiresDays = { Integer.valueOf(30), Integer.valueOf(365), Integer.valueOf(1000), Integer.valueOf(3650), Integer.valueOf(36500) };
    ...
    costunits = new JComboBox(unitOfCostList);
    ...
    JComponent panel2 = new javax.swing.JPanel(new java.awt.GridBagLayout());
  ...
  public void actionPerformed(ActionEvent e)
  {
    if (e.getSource() == generateButton) {
      try {
        ...
        JOptionPane.showMessageDialog(this, "Invalid number entered for cost.", "NumberFormatException", 0);
      }
  ...
  public void insertUpdate(DocumentEvent e)
  {
    try {
      ...
      JOptionPane.showMessageDialog(this, "Invalid number entered for cost.", "NumberFormatException", JOptionPane.ERROR_MESSAGE);
    }
  }
  ...
  public void displayCryptoIcon() {
    ...
    case "Bitcoin": 
      cryptoLabel.setIcon(new javax.swing.ImageIcon(LicenseKeyGenerator.class
        .getResource("images/btc2.png")));
      break;
    case "Litecoin": 
      cryptoLabel.setIcon(new javax.swing.ImageIcon(LicenseKeyGenerator.class
        .getResource("images/ltc2.png")));
    }
  ...
  public void generateLicenses()
  {
    try
    {
      for (int i = 1; i < walletids.size(); i++)
      {
        ...
        String dirname = new String(((String)walletids.get(i)).substring(((String)walletids.get(i)).length() - 8, ((String)walletids.get(i)).length()));
        
        new File(directoryNameLabel.getText() + "/license/" + dirname).mkdirs();
        
        String filename = new String(directoryNameLabel.getText() + "/license/" + dirname + "/license.ser");
